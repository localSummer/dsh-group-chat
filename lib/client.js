	...
	factory: (require) => {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								mention !== null && mention.query === "" && mentionCandidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									role: "listbox",
									children: [fileSearchLoading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dsgc-mentionitem dsgc-hint",
										children: "检索中…"
									}) : fileSearchError ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dsgc-mentionitem dsgc-hint",
										children: fileSearchError
									}) : fileCandidates.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dsgc-mentionitem dsgc-hint",
										children: "无匹配文件"
									}) : fileCandidates.map((item, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										type: "button",
										className: "dsgc-mentionitem" + (i === mentionIdxC ? " on" : ""),
										role: "option",
										"aria-selected": i === mentionIdxC ? "true" : "false",
										...
										className: "dsgc-mentionhint",
										children: fileCandidates.some((f) => f.isDir) ? "↑↓ 选择 · Enter 插入 · Tab 进入目录 · Esc 关闭" : "↑↓ 选择 · Enter 插入 · Esc 关闭"
									})]
								}) : null,
		...
		*/
		...
		function fileChipHtml(path, kind) {
			...
			return "<span class=\"dsgc-chipin dsgc-chipin-file\" data-kind=\"file\" data-path=\"" + escapeHtml(path) + "\" contenteditable=\"false\" draggable=\"true\">" + icon + " " + escapeHtml(basename) + "</span>";
		}
		/**
		...
		*/
		function useFileSearch(mention, groupId, action) {
		...
		*/
		function GroupChatPanel() {
			...
			const { fileCandidates, fileSearchError, fileSearchLoading } = useFileSearch(mention, group?.id, action);
