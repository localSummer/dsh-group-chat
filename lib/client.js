	...
	factory: (require) => {
		...
		*/
		...
		function Icon(comp, size, extra) {
			return h$2(comp, Object.assign({ size }, extra || {}));
		}
		//#endregion
		...
		*/
		...
		function ThinkRow(props) {
			...
			return h$2("div", { className: "dsgc-think" }, h$2(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
				rowClassName: "dsgc-thinkrow",
				icon: h$2(_deepseek_ai_dsh_client_ui_primitives.IconThinkOutline14, { size: 14 }),
				title: "思考",
				open: expanded,
				expandable: true,
				...
				collapsedContent: text ? h$2("span", { className: "dsgc-thinksummary" }, summary) : null
			}, h$2("div", { className: "dsgc-thinkbody" }, text)));
		}
		...
		function ToolRow(props) {
			...
			const iconComp = TOOL_ICONS[c.tool] || "IconCodeOutline16";
			...
			return h$2("div", { className: "dsgc-tool" }, h$2(_deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
				rowClassName: "dsgc-toolrow",
				icon: h$2(iconComp, { size: 14 }),
				...
				collapsedContent: h$2("span", { className: "dsgc-toolsummary" }, h$2(statusIcon, {
					size: 12,
					style: {
						verticalAlign: "-2px",
						marginRight: 4,
			...
			}, h$2("div", { className: "dsgc-toolbody" }, c.output || "（无输出）")));
		}
		...
		function Bubble(props) {
			...
			if (isSys) return h$2("div", { className: "dsgc-sysmsg" + (m.error ? " err" : "") }, m.text);
			const body = isUser ? h$2("div", { className: "dsgc-msgtext" }, m.text) : h$2("div", { className: "dsgc-msgtext" }, m.reasoning ? h$2(ThinkRow, { text: m.reasoning }) : null, (Array.isArray(m.toolCalls) ? m.toolCalls : []).map((c, i) => h$2(ToolRow, {
				key: "tc" + i,
				c
			})), h$2(_deepseek_ai_dsh_client_ui_primitives.MarkdownText, {
				text: m.text || "（无内容）",
				labels: MD_LABELS
			}));
			return h$2("div", { className: "dsgc-msg" + (isUser ? " mine" : "") }, h$2("div", {
				className: "dsgc-avatar" + (isUser ? " mine" : ""),
				style: isUser || !role ? void 0 : { border: "2px solid " + (role.color || "#888") }
			}, name.slice(0, 1)), h$2("div", { className: "dsgc-msgbody" }, h$2("div", { className: "dsgc-msghead" }, h$2("span", { className: "dsgc-msgname" }, name), m.model ? h$2("span", {
				className: "dsgc-msgmodel",
				title: m.model
			}, m.model) : null, m.ts ? h$2("span", { className: "dsgc-msgtime" }, fmtTime(m.ts)) : null), body));
		}
		//#endregion
		//#region src/client/drawer.ts
		/**
		...
		*/
		function RoleDrawer(props) {
			...
			return h$2("div", {
			...
			}, h$2("div", { className: "dsgc-drawerhead" }, Icon(_deepseek_ai_dsh_client_ui_primitives.IconUserOutline16, 16), h$2("span", { className: "dsgc-drawertitle" }, draft.id ? "编辑角色" : "添加角色"), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "ghost",
				size: "sm",
				onClick: close,
				"aria-label": "关闭"
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconCloseOutline16, 16))), h$2("div", { className: "dsgc-drawerbody" }, h$2("div", { className: "dsgc-form" }, h$2("div", { className: "dsgc-field" }, h$2("label", null, "名称"), h$2("input", {
				className: "dsgc-input",
				value: draft.name,
				autoFocus: !draft.id,
				onChange: (e) => set(Object.assign({}, draft, { name: e.target.value })),
				placeholder: "例如：产品经理"
			})), h$2("div", { className: "dsgc-field" }, h$2("label", null, "标识色"), h$2("div", { className: "dsgc-palette" }, PALETTE.map((c) => h$2("button", {
				key: c,
				type: "button",
				...
				"aria-label": "选择标识色 " + c
			})))), h$2("div", { className: "dsgc-field" }, h$2("label", null, "人设 / 角色设定"), h$2("textarea", {
				className: "dsgc-textarea",
				rows: 4,
				value: draft.persona,
				onChange: (e) => set(Object.assign({}, draft, { persona: e.target.value })),
				placeholder: "性格、立场、说话风格、专业背景……"
			})), h$2("div", { className: "dsgc-field" }, h$2("label", null, "模型提供方"), providers.length ? h$2("select", {
				className: "dsgc-select",
				value: draft.provider,
				onChange: onProvider
			}, h$2("option", { value: "" }, "选择提供方…"), providers.map((p) => h$2("option", {
				key: p.id,
				value: p.id
			}, p.name || p.id))) : h$2("div", { className: "dsgc-selhint" }, (props.modelsError ? "模型目录加载失败：" + props.modelsError : "暂无可用 provider") + " ", h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				size: "sm",
				onClick: props.onRetryModels
			}, "重试"))), h$2("div", { className: "dsgc-field" }, h$2("label", null, "模型"), modelsOf.length ? h$2("select", {
				className: "dsgc-select",
				value: draft.model,
				onChange: (e) => set(Object.assign({}, draft, {
					model: e.target.value,
					reasoningEffort: "default"
				}))
			}, modelsOf.map((m) => h$2("option", {
				key: m.id,
				value: m.id
			}, m.name || m.id))) : h$2("div", { className: "dsgc-selhint" }, "请先选择有可用模型的提供方")), h$2("div", { className: "dsgc-field" }, h$2("label", null, "温度（可选）"), h$2("input", {
				className: "dsgc-input",
				type: "number",
				step: "0.1",
				min: "0",
				...
				onChange: (e) => set(Object.assign({}, draft, { temperature: e.target.value === "" ? void 0 : Number(e.target.value) }))
			})), h$2("div", { className: "dsgc-field" }, h$2("label", null, "深度思考"), h$2("div", { style: {
				display: "flex",
				gap: 10,
				alignItems: "center"
			} }, h$2(_deepseek_ai_dsh_client_ui_primitives.Switch, {
				checked: draft.thinking === true,
				onChange: (v) => set(Object.assign({}, draft, { thinking: v })),
				label: "深度思考"
			}), h$2("span", { className: "dsgc-hint" }, "开启后角色发言前先思考（支持思考的模型）"))), draft.thinking === true ? h$2("div", { className: "dsgc-field" }, h$2("label", null, "推理级别"), effortsInfo === null ? h$2("div", { className: "dsgc-selhint" }, "查询推理级别…") : !effortsInfo.ok ? h$2("div", { className: "dsgc-selhint" }, "推理级别查询失败：" + effortsInfo.error + "（若刚更新插件，请重启 dsh web 使 host 半生效）") : (effortsInfo.efforts || []).length ? h$2("select", {
				className: "dsgc-select",
			...
			}, h$2("option", { value: "default" }, "默认" + (effortsInfo.defaultEffort ? "（当前默认：" + ((effortsInfo.efforts || []).find((x) => x.id === effortsInfo.defaultEffort) || { name: "" }).name + "）" : "")), (effortsInfo.efforts || []).map((e) => h$2("option", {
				key: e.id,
				value: e.id,
				title: e.description || ""
			}, e.name || e.id))) : h$2("div", { className: "dsgc-selhint" }, "当前模型未提供推理等级，将使用默认")) : null, props.formError ? h$2("div", { className: "dsgc-formerr" }, props.formError) : null)), h$2("div", { className: "dsgc-drawerfoot" }, h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				onClick: close
		...
		*/
		function GroupChatPanel() {
			...
			if (!snap) return h$2("div", { className: "dsgc-root" }, h$2("div", { className: "dsgc-loading" }, Icon(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, 16), "加载中…"));
			let group = gid ? groupById(snap, gid) : null;
			if (!group && snap.groups.length) group = snap.groups[0];
			if (!group) return h$2("div", { className: "dsgc-root" }, h$2("div", { className: "dsgc-loading" }, "暂无群组"));
			...
			if (busyNow && snap.run.currentRoleId) {
				...
				}, lr.name.slice(0, 1)), h$2("div", { className: "dsgc-msgbody" }, h$2("div", { className: "dsgc-msghead" }, h$2("span", { className: "dsgc-msgname" }, lr.name), h$2("span", { className: "dsgc-msgmodel" }, lr.provider + " / " + lr.model), h$2("span", { className: "dsgc-msgtime" }, "正在输入…")), h$2("div", { className: "dsgc-msgtext live" }, snap.run.partialReasoning ? h$2(ThinkRow, {
					text: snap.run.partialReasoning,
					running: true
				}) : null, snap.run.partial ? h$2(_deepseek_ai_dsh_client_ui_primitives.MarkdownText, {
			...
			if (pc) {
				const lr = roleById(snap, snap.run.currentRoleId);
				bubbles.push(h$2("div", {
					key: "__confirm",
					className: "dsgc-confirm"
				}, h$2("div", { className: "dsgc-confirmtitle" }, Icon(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, 14), (lr ? lr.name : "角色") + " 请求执行命令（工作区内）"), h$2("div", { className: "dsgc-confirmcmd" }, String(pc.args && pc.args.command || "")), h$2("div", { className: "dsgc-hint" }, "允许后将在工作区目录执行；拒绝后角色将继续纯文本讨论"), h$2("div", { className: "dsgc-confirmops" }, h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
					variant: "primary",
					size: "sm",
					onClick: () => {
						action({
				...
				}, "允许"), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
					variant: "outline",
					size: "sm",
					onClick: () => {
						action({
			...
			for (const g of snap.groups) {
				...
				if (expanded) {
					for (const sessionId of g.sessionIds) {
						...
						}, h$2("span", { className: "dsgc-sess-dot" }), isRenameSess ? h$2("input", {
						...
						}) : h$2("span", { className: "dsgc-sess-name" }, s.name), h$2("span", { className: "dsgc-nodeops" }, h$2("button", {
						...
						}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconEditOutline16, 14)), h$2("button", {
						...
						}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutline16, 14)))));
					}
					groupChildren.push(h$2("button", {
						key: "__add",
					...
					}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutline16, 14), "新会话"));
				}
				treeNodes.push(h$2("div", {
					key: g.id,
				...
				}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, 14)), isRenameGroup ? h$2("input", {
					className: "dsgc-rename",
					value: renameDraft.value,
					autoFocus: true,
					onChange: (e) => setRenameDraft({
					...
					onKeyDown: renameKeyDown,
					onClick: (e) => e.stopPropagation()
				}) : h$2("span", { className: "dsgc-gname" }, g.name), h$2("span", { className: "dsgc-nodeops" }, h$2("button", {
					className: "dsgc-opbtn",
					title: "重命名群组",
					"aria-label": "重命名群组",
					onClick: (e) => {
				...
				}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutline16, 14)))), expanded ? h$2("div", { className: "dsgc-sess-list" }, groupChildren) : null));
			}
			const navPanel = h$2("div", { className: "dsgc-nav" }, h$2(_deepseek_ai_dsh_client_ui_primitives.Input, {
				icon: Icon(_deepseek_ai_dsh_client_ui_primitives.IconSearchOutline16, 16),
				className: "dsgc-search",
				placeholder: "搜索群组与会话…",
				value: search,
				onChange: (e) => setSearch(e.target.value)
			}), treeNodes.length ? h$2("div", { className: "dsgc-tree" }, treeNodes) : h$2("div", { className: "dsgc-hint" }, q ? "没有匹配「" + search.trim() + "」的群组或会话" : "暂无群组"), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				onClick: () => {
					mutate({ op: "createGroup" });
				}
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutline16, 16), "新建群组"));
			const asidePanel = h$2("div", {
				className: "dsgc-aside" + (asideOpen ? "" : " closed"),
				"aria-hidden": asideOpen ? void 0 : "true"
			}, h$2("div", { className: "dsgc-sec" }, h$2("div", { className: "dsgc-sechead" }, "群成员", h$2("span", { className: "dsgc-secspacer" }), h$2("span", { className: "dsgc-seccount" }, group.roleIds.length ? group.roleIds.length + " 个" : ""), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "ghost",
				size: "sm",
				onClick: () => {
					openRoleEditor(null);
				...
				"aria-label": "添加角色"
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutline16, 14), "添加")), group.roleIds.length ? h$2("div", { className: "dsgc-roles" }, group.roleIds.map((rid) => {
				...
				return h$2("div", {
					...
					title: "点击编辑角色"
				}, h$2("div", { className: "dsgc-rolehead" }, h$2("span", {
					className: "dsgc-roledot",
					style: { background: r.color || "#888" }
				}), h$2("span", { className: "dsgc-rolename" }, r.name), h$2(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					...
					title: r.persona
				}, r.persona) : null, h$2("div", { className: "dsgc-rolemenu" }, h$2("span", {
				...
				}, r.provider + " / " + r.model), r.thinking ? h$2("span", {
					title: "深度思考",
					style: {
						display: "inline-flex",
						alignItems: "center",
				...
				}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconThinkOutline14, 14)) : null, h$2("span", { className: "dsgc-roleops" }, h$2("button", {
					className: "dsgc-opbtn",
					title: "编辑角色",
					"aria-label": "编辑角色",
					onClick: (e) => {
			...
			})) : h$2("div", { className: "dsgc-hint" }, "还没有角色。每个角色可绑定不同的 provider/model，在群内以独立身份发言。")), h$2("div", { className: "dsgc-sec" }, h$2("div", { className: "dsgc-sechead" }, "工作区目录"), h$2("div", { className: "dsgc-field" }, h$2("div", { className: "dsgc-wsrow" }, h$2("input", {
				className: "dsgc-input",
			...
			}), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				size: "sm",
				onClick: () => {
					openBrowser(wsDraft === null ? group.workspaceDir : wsDraft);
				}
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpenOutline16, 14), "浏览")), h$2("div", { className: "dsgc-hint" }, "发送时读取目录内文本文件，注入本群全体角色上下文；角色也可用工具主动查看"), group.workspaceDir === "~" || group.workspaceDir === "/" ? h$2("div", { className: "dsgc-err" }, "工作区指向整个主目录/根目录：角色的只读工具将可读取该范围下的所有文件，请谨慎") : null), h$2("div", { className: "dsgc-field" }, h$2("div", {
			...
			}, "允许角色执行命令（逐条确认）"), h$2(_deepseek_ai_dsh_client_ui_primitives.Switch, {
				...
				label: "允许角色执行命令",
				"aria-label": "允许角色执行命令"
			})), h$2("div", { className: "dsgc-hint" }, group.allowCommands === true ? "角色可请求在工作区内执行 shell 命令（cwd 固定为工作区）；每条命令执行前需在会话中确认，超时 120 秒" : "开启后角色可在讨论中请求运行测试等命令；默认关闭")), fileBrowser && fileBrowser.open ? h$2("div", { className: "dsgc-fb" }, h$2("div", { className: "dsgc-fbhead" }, h$2("span", {
				className: "dsgc-fbpath",
				title: fileBrowser.list ? fileBrowser.list.path : ""
			}, fileBrowser.loading ? "读取中…" : fileBrowser.list ? fileBrowser.list.path : ""), h$2("span", { style: {
				display: "flex",
				gap: 4,
				alignItems: "center"
			} }, h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
			...
			}, "选定此目录"), fileBrowser.list ? h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				size: "sm",
				title: "上一级",
				"aria-label": "上一级",
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, 14)) : null, fileBrowser.list ? h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				size: "sm",
				title: "主目录",
				"aria-label": "主目录",
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconFolderClose16, 14)) : null, h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "ghost",
				size: "sm",
				onClick: () => setFileBrowser(null),
				"aria-label": "关闭浏览器"
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconCloseOutline16, 14)))), fileBrowser.error ? h$2("div", { className: "dsgc-err" }, fileBrowser.error) : null, fileBrowser.list ? h$2("div", { className: "dsgc-fblist" }, (fileBrowser.list.entries || []).length ? (fileBrowser.list.entries || []).map((e) => e.type === "directory" ? h$2("button", {
				key: e.path,
				type: "button",
			...
			}, Icon(e.hidden ? _deepseek_ai_dsh_client_ui_primitives.IconFolderClose16 : _deepseek_ai_dsh_client_ui_primitives.IconFolderOpenOutline16, 14), h$2("span", { className: "dsgc-fbname" }, e.name + "/")) : h$2("div", {
				key: e.path,
				className: "dsgc-fbrow dim file"
			}, h$2("span", { className: "dsgc-fbname" }, e.name), e.size !== void 0 ? h$2("span", { className: "dsgc-fbsize" }, _deepseek_ai_dsh_client_ui_primitives.fileSizeText(e.size)) : null)) : h$2("div", { className: "dsgc-hint" }, "空目录")) : null) : null));
			const chatPanel = h$2("section", { className: "dsgc-chat" }, h$2("div", { className: "dsgc-chathead" }, sess ? h$2("span", {
				className: "dsgc-sess-title",
				title: "当前会话：" + sess.name
			}, sess.name) : null, h$2("input", {
			...
			}, "清空"), h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "ghost",
				size: "sm",
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconPanelLeftOutline16, 16))), h$2("div", {
				className: "dsgc-msgs",
				ref: scrollRef,
				onScroll: onMsgsScroll
			}, bubbles.length ? bubbles : h$2("div", { className: "dsgc-empty" }, Icon(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, 20), h$2("div", { className: "dsgc-emptytitle" }, sess && sess.topic ? "「" + sess.topic + "」" : "会话已就绪"), h$2("div", { className: "dsgc-hint" }, enabledRoles.length ? "发送消息开始讨论；@成员 点名让其优先回应；留空直接发送可让角色自由讨论——每轮全体参与角色按顺序各发言一次，可用右下角轮数控制（1–10 轮）" : "先在右侧添加角色（每个角色可绑定不同模型），再回到这里发起讨论。"))), h$2("div", { className: "dsgc-composer" }, !atBottom && bubbles.length ? h$2("div", { className: "dsgc-tobottom" }, h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				size: "sm",
				onClick: () => {
					const el = scrollRef.current;
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, 14), "回到底部")) : null, err ? h$2("div", { className: "dsgc-err" }, err) : null, h$2("div", { className: "dsgc-parts" }, h$2("span", { className: "dsgc-partslabel" }, "参与角色"), mentionedRoles.length ? h$2("span", { className: "dsgc-partslabel" }, "已 @ " + mentionedRoles.map((r) => r.name).join("、") + "（本轮仅被点名成员发言）") : enabledRoles.length ? enabledRoles.map((r) => h$2("button", {
				key: r.id,
				type: "button",
				...
				style: { background: r.color || "#888" }
			}), r.name)) : h$2("span", { className: "dsgc-hint" }, "还没有启用的角色，请在右侧添加")), h$2("div", { className: "dsgc-mentionwrap" }, mention && mentionCandidates.length > 0 ? h$2("div", {
				className: "dsgc-mention",
				role: "listbox"
			}, mentionCandidates.map((r, i) => h$2("button", {
				key: r.id,
				type: "button",
				...
				className: "dsgc-chipdot",
				style: { background: r.color || "#888" }
			}), h$2("span", { className: "dsgc-mentionname" }, r.name), h$2("span", { className: "dsgc-mentionmodel" }, r.provider + " / " + r.model))), h$2("span", { className: "dsgc-mentionhint" }, "↑↓ 选择 · Enter/Tab 插入 · Esc 关闭")) : null, h$2("textarea", {
				className: "dsgc-textarea",
				ref: inputRef,
				rows: 2,
			...
			})), h$2("div", { className: "dsgc-sendrow" }, h$2("span", { style: { flex: 1 } }), h$2("div", {
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconChevronLeftOutline14, 12)), h$2("span", {
			...
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, 12)), h$2("span", { style: { padding: "0 6px 0 2px" } }, "轮")), busyNow ? h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "outline",
				className: "dsgc-stopbtn",
				onClick: () => {
					stopRun();
				}
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconStopFill16, 16), "停止") : h$2(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "primary",
				onClick: () => {
					sendMsg();
				},
				disabled: !participants.length && !mentionedRoles.length || !sess
			}, Icon(_deepseek_ai_dsh_client_ui_primitives.IconSendOutline16, 16), "发送"))));
			return h$2("div", { className: "dsgc-root" }, navPanel, chatPanel, asidePanel, roleDraft ? h$2(RoleDrawer, {
				draft: roleDraft,
				set: setRoleDraft,
				models,
				modelsError,
		...
		*/
		function GroupChatSettingsSection(props) {
			...
			return h$2("div", { className: "dgcs-page" }, h$2("div", { className: "dgcs-head" }, h$2("h3", { className: "dgcs-title" }, "模型群聊"), h$2("p", { className: "dgcs-desc" }, "多模型角色群组对话面板：每个角色绑定不同的 provider/model；群组内多会话目录树管理，群内共享对话记录与资料空间；消息以 markdown 渲染、支持思考折叠；输入框支持 @成员 点名。数据持久化于 ~/.dsh/storages/group-chat/，重启 dsh web 后恢复。")), h$2("div", { className: "dgcs-card" }, h$2("div", { className: "dgcs-cardtext" }, h$2("div", { className: "dgcs-cardtitle" }, enabled ? "已启用" : "已停用"), h$2("div", { className: "dgcs-cardhint" }, writable ? enabled ? "关闭后侧边栏将不再显示「群聊」入口，进行中的对话会被中止。" : "开启后侧边栏显示「群聊」入口。" : "当前设置不可写（可能被配置文件覆盖）。")), h$2(_deepseek_ai_dsh_client_ui_primitives.Switch, {
				checked: enabled,
				onChange: () => {
					toggle();
				},
		...
		*/
		function Glyph(props) {
			...
			return (0, react.createElement)("span", { className: "dsgc-entryOverlay newSession" }, (0, react.createElement)("span", { className: "dsgc-entryIcon" }, (0, react.createElement)("svg", {
				width: size,
				height: size,
				viewBox: "0 0 24 24",
				fill: "none",
				...
				"aria-hidden": "true"
			}, (0, react.createElement)("path", { d: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" }), (0, react.createElement)("circle", {
				cx: 9,
				cy: 7,
				r: 4
			}), (0, react.createElement)("path", { d: "M23 21v-2a4 4 0 0 0-3-3.87" }), (0, react.createElement)("path", { d: "M16 3.13a4 4 0 0 1 0 7.75" }))));
		}
		//#endregion
