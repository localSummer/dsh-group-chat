...
function fakeCore(): HostState {
  const run: RunState = { running: false, sessionId: null, currentRoleId: null, partial: '', partialReasoning: '', stopping: false, queue: [], queueIndex: 0, turnStartedAt: null, pendingConfirm: null, confirmSignal: null, commandAbort: null, finished: null, replaceMessageId: null }
