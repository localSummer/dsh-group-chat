...
describe('会话状态派生（sessStatus）', () => {
  ...
  const run = (o: Partial<import('../src/core/types.ts').Snapshot['run']>): import('../src/core/types.ts').Snapshot['run'] => ({
    running: false, sessionId: null, currentRoleId: null, partial: '', partialReasoning: '', queue: [], queueIndex: 0, turnStartedAt: null, pendingConfirm: null, finished: null, replaceMessageId: null, ...o,
  })
